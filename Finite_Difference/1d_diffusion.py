...
c2 = theta_scheme([0,1], 0.2, 501, 1.0, 0.2, 0, [1,0], c0_fun)
c3 = theta_scheme([0,1], 0.2, 501, 1.0, 0.502, 0, [1,0], c0_fun)
c4 = theta_scheme([0,1], 0.2, 101, 1.0, 0.5, 0, [1,0], c0_fun)

#Crank-Nicolson
c5 = theta_scheme([0,1],0.2,501,1.0,5.0,0.5,[1,0],c0_fun)
...
ax1.plot(mesh,analytical_dirichlet(0.1,mesh,100), label="Analytical")
ax1.legend()
ax1.set_xlabel(r"$x$")
ax1.set_ylabel(r"$c$")
